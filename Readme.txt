...
Easy deployment requires an empty db and for the files to be unzipped to you php hotdogs folder, the tables are setup automatically during the installation process.

Multiple menus can be setup and placed throughout you site independently. The template model can be loaded and used from within a mvc custom app which allows the menus to be uniform and updated throughout where ever they are placed.

 

Developer Notes

The micro mvc can be used independently of the cms or the pages and or content tables can be used by an mvc app so the system can index content in the site search.
