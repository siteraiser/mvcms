...
include_once(BASE_URI.'/app/system/config/config.inc.php');

include_once(BASE_URI.'/app/classes/User.php');
...
if($user->getId()){
	$Config['Enabled'] = true ;
	if(!is_dir(BASE_URI.'/userfiles/'.$user->getId())){
		mkdir(BASE_URI.'/userfiles/'.$user->getId(), 0777);			
	}
...
$Config['UserFilesPath'] = '/userfiles/'.$user->getId().'/' ;

// Fill the following value it you prefer to specify the absolute path for the
// user files directory. Useful if you are using a virtual directory, symbolic
// link or alias. Examples: 'C:\\MySite\\userfiles\\' or '/root/mysite/userfiles/'.
// Attention: The above 'UserFilesPath' must point to the same directory.
$Config['UserFilesAbsolutePath'] = BASE_URI.'/userfiles/'.$user->getId().'/';
...
$Config['ConfigAllowedCommands'] = array('QuickUpload', 'FileUpload', 'GetFolders', 'GetFoldersAndFiles', 'CreateFolder','DeleteFolder','DeleteFile') ;//last 2 new additions via Carl 2-29-2016
